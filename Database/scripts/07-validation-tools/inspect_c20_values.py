...
# Read with header detection logic
...
# Print values for specific columns
cols_of_interest = ['WEC', 'Notes', 'Kit No']
# Add unnamed columns
cols_of_interest.extend([c for c in df.columns if 'Unnamed' in c])

print("Columns of interest:", cols_of_interest)
print("\nFirst 5 rows:")
